...
export const RetryRequestWithTimeout = async (fn, params, retryOptions) => {
    ...
    while (shouldRetry(count, retryOptions.maxRetries)) {
        ...
        await new Promise((resolve) => setTimeout(resolve, setDelay(count, retryOptions.initialDelay)));
        try {
